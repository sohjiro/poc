defmodule PocWeb.UserLiveTest do
  use PocWeb.ConnCase
  ...
  @create_attrs %{email: "some email", last_name: "some last_name", name: "some name", phone: "some phone"}
  ...
  defp fixture(:user) do
    {:ok, user} = Profile.create_user(@create_attrs)
    user
  end
